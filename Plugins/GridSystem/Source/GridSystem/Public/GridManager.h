...
private:
  ...
  void CreateLineProceduralMesh(UProceduralMeshComponent *mesh, const TArray<FVector> &vertices,
                                const TArray<int> &triangles);
  void CreateSelectionProceduralMesh(UProceduralMeshComponent *mesh, const TArray<FVector> &vertices,
                                     const TArray<int> &triangles);
};
