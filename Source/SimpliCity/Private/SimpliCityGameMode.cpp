...
void ASimpliCityGameMode::StartPlay() {
  ...
  ASimpliCityPlayerController* controller =  Cast<ASimpliCityPlayerController>(UGameplayStatics::GetPlayerController(this,0));
  auto NewWidget = CreateWidget<USimpliCityMainUI>(controller,BuildUIClass);
  NewWidget->AddToViewport();
  controller->TheMainUI = NewWidget;
  Super::StartPlay();
}